(function () {
  ...
  css.textContent =
    ...
    'padding:0;border:2px solid rgba(0,82,255,.55);background:#05060a;cursor:pointer;overflow:visible;' +
    'box-shadow:0 0 0 2px rgba(0,82,255,.25),0 0 28px rgba(0,82,255,.4),0 0 48px rgba(0,82,255,.22);' +
    'transition:transform .2s,box-shadow .2s}' +
    '#gp-fab:hover,#gp-fab:focus-visible{transform:scale(1.05);box-shadow:0 0 0 2px rgba(0,82,255,.65),0 0 36px rgba(0,82,255,.55),0 0 60px rgba(0,82,255,.3);outline:none}' +
    ...
    'border:1px solid rgba(0,82,255,.28);border-radius:20px;' +
    'box-shadow:0 24px 60px -18px rgba(0,0,0,.9),0 0 32px rgba(0,82,255,.22),0 0 48px rgba(0,82,255,.12);' +
    ...
    'padding:14px 16px;border-bottom:1px solid rgba(0,82,255,.18)}' +
    '#gp-panel .gp-head h3{margin:0;font:700 15px Sora,Inter,sans-serif;letter-spacing:.02em}' +
    '#gp-panel .gp-head h3 span{color:#0052ff}' +
    ...
    '#gp-panel .gp-x:hover{color:#eefaff;background:rgba(0,82,255,.1)}' +
    ...
    'font:600 12px Inter,system-ui,sans-serif;color:#05060a;background:linear-gradient(135deg,#0052ff,#2667ff);' +
    'border:0;border-radius:999px;padding:9px 16px;cursor:pointer;box-shadow:0 0 18px rgba(0,82,255,.4);' +
    'display:none}' +
    ...
    '#gp-panel .gp-msg.bot{background:rgba(12,18,32,.75);border:1px solid rgba(0,82,255,.18);align-self:flex-start}' +
    '#gp-panel .gp-msg.user{background:linear-gradient(135deg,rgba(0,82,255,.18),rgba(0,82,255,.14));' +
    'border:1px solid rgba(0,82,255,.28);align-self:flex-end}' +
    '#gp-panel .gp-form{display:flex;gap:8px}' +
    '#gp-panel .gp-form input{flex:1;background:rgba(8,12,22,.8);border:1px solid rgba(0,82,255,.22);' +
    'border-radius:999px;color:#eefaff;font:400 13px Inter,system-ui,sans-serif;padding:11px 14px;outline:none}' +
    '#gp-panel .gp-form input:focus{border-color:rgba(0,82,255,.55);box-shadow:0 0 14px rgba(0,82,255,.2)}' +
    '#gp-panel .gp-form button{background:linear-gradient(135deg,#0052ff,#2667ff);color:#05060a;border:0;' +
