(function () {
  ...
  css.textContent =
    ...
    'padding:0;border:2px solid rgba(95,208,255,.55);background:#05060a;cursor:pointer;overflow:visible;' +
    'box-shadow:0 0 0 2px rgba(95,208,255,.25),0 0 28px rgba(95,208,255,.4),0 0 48px rgba(155,123,255,.22);' +
    'transition:transform .2s,box-shadow .2s}' +
    '#gp-fab:hover,#gp-fab:focus-visible{transform:scale(1.05);box-shadow:0 0 0 2px rgba(95,208,255,.65),0 0 36px rgba(95,208,255,.55),0 0 60px rgba(155,123,255,.3);outline:none}' +
    ...
    'background:#3ddc84;border:2px solid #05060a;box-shadow:0 0 10px rgba(61,220,132,.7)}' +
    '#gp-fab .gp-pulse::after{content:"";position:absolute;inset:-4px;border-radius:50%;border:2px solid rgba(61,220,132,.55);' +
    'animation:gp-pulse-ring 2s ease-out infinite}' +
    '#gp-fab .gp-live{position:absolute;left:50%;bottom:-18px;transform:translateX(-50%);' +
    'font:700 9px ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.14em;color:#3ddc84;' +
    'background:rgba(5,6,10,.85);padding:2px 7px;border-radius:999px;border:1px solid rgba(61,220,132,.35)}' +
    ...
    'background:rgba(6,8,14,.94);backdrop-filter:blur(20px) saturate(1.2);-webkit-backdrop-filter:blur(20px) saturate(1.2);' +
    'border:1px solid rgba(95,208,255,.28);border-radius:20px;' +
    'box-shadow:0 24px 60px -18px rgba(0,0,0,.9),0 0 32px rgba(95,208,255,.22),0 0 48px rgba(155,123,255,.12);' +
    'font-family:Inter,system-ui,sans-serif;color:#eefaff;overflow:hidden}' +
    '#gp-panel.is-open{display:flex}' +
    '#gp-panel .gp-head{display:flex;align-items:center;justify-content:space-between;gap:10px;' +
    'padding:14px 16px;border-bottom:1px solid rgba(95,208,255,.18)}' +
    '#gp-panel .gp-head h3{margin:0;font:700 15px Sora,Inter,sans-serif;letter-spacing:.02em}' +
    '#gp-panel .gp-head h3 span{color:#5fd0ff}' +
    '#gp-panel .gp-x{background:transparent;border:0;color:#8892a4;font-size:22px;line-height:1;cursor:pointer;padding:4px 8px;border-radius:8px}' +
    '#gp-panel .gp-x:hover{color:#eefaff;background:rgba(95,208,255,.1)}' +
    '#gp-panel .gp-vid-wrap{position:relative;background:#05060a;aspect-ratio:1;max-height:220px}' +
    '#gp-panel video{width:100%;height:100%;object-fit:cover;display:block;background:#05060a}' +
    '#gp-panel .gp-hear{position:absolute;left:50%;bottom:12px;transform:translateX(-50%);' +
    'font:600 12px Inter,system-ui,sans-serif;color:#05060a;background:linear-gradient(135deg,#5fd0ff,#9b7bff);' +
    'border:0;border-radius:999px;padding:9px 16px;cursor:pointer;box-shadow:0 0 18px rgba(95,208,255,.4);' +
    'display:none}' +
    ...
    '#gp-panel .gp-msg.bot{background:rgba(12,18,32,.75);border:1px solid rgba(95,208,255,.18);align-self:flex-start}' +
    '#gp-panel .gp-msg.user{background:linear-gradient(135deg,rgba(95,208,255,.18),rgba(155,123,255,.14));' +
    'border:1px solid rgba(95,208,255,.28);align-self:flex-end}' +
    '#gp-panel .gp-form{display:flex;gap:8px}' +
    '#gp-panel .gp-form input{flex:1;background:rgba(8,12,22,.8);border:1px solid rgba(95,208,255,.22);' +
    'border-radius:999px;color:#eefaff;font:400 13px Inter,system-ui,sans-serif;padding:11px 14px;outline:none}' +
    '#gp-panel .gp-form input:focus{border-color:rgba(95,208,255,.55);box-shadow:0 0 14px rgba(95,208,255,.2)}' +
    '#gp-panel .gp-form button{background:linear-gradient(135deg,#5fd0ff,#9b7bff);color:#05060a;border:0;' +
  ...
  function mount() {
    ...
    fab.innerHTML =
      '<img src="/cyre-token-256.png" alt="" width="64" height="64">' +
