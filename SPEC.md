...
| `api/_grade.js` | Shared Solana graders for agent skills — `gradeAddress`, `mintAuthorityFacts`, `programNovelty`, seed `mintAffinity`, known-program set. Used by handshake + preflight. |
